package main.java.com.raphydaphy.automania.font;
...
public class GUIText
{
	...
	private int meshPositionsVBO;
	private int meshUvsVBO;
	...
	public int getMeshPositionsVBO()
	{
		return meshPositionsVBO;
	}

	public int getMeshUvsVBO()
	{
		return meshUvsVBO;
	}
	 ...
	 */
	public void setMeshInfo(int vao, int positionsVBO, int uvsVBO, int verticesCount)
	{
		this.textMeshVao = vao;
		this.meshPositionsVBO = positionsVBO;
		this.meshUvsVBO = uvsVBO;
